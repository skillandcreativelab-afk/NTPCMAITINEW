  ...
  return (
    <section className="">
      ...
      <div className="p-6 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6">
        {/* Box 1 */}
        <div className="bg-gradient-to-r from-blue-900 via-blue-800 to-blue-700 p-6 rounded-xl shadow-lg text-white transform hover:-translate-y-2 hover:shadow-2xl transition duration-300 cursor-pointer">
      ...
      <div className="flex flex-col md:flex-row w-full gap-12 justify-center items-start mx-auto max-w-6xl mt-10 ">
        {/* Quick Links */}
        <div className="bg-white h-[320px] w-[600px] border rounded-xl hover:shadow-2xl transition duration-300 shadow-[0_10px_25px_rgba(30,64,175,0.6)]">
...
<li className="flex items-center justify-between hover:bg-blue-50 p-2 rounded transition cursor-pointer">
  ...
  >
    ...
    <FaExternalLinkAlt />
        ...
        {/* Notice Board */}
        <div className="bg-white border rounded-xl md h-[320px] w-[600px] hover:shadow-2xl transition duration-300 shadow-[0_10px_25px_rgba(30,64,175,0.6)]">
